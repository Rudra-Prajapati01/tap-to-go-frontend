    ...
    <footer style={styles.footer}>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.bottomBar}>
          ...
          <p style={styles.bottomText}>Made with devotedinfotech</p>
        </div>
...
const styles = {
  ...
  glowLeft: {
    ...
    width: "300px",
    borderRadius: "50%",
    backgroundColor: "rgba(97, 85, 166, 0.15)",
    filter: "blur(100px)",
    pointerEvents: "none",
  },
  glowRight: {
    ...
    width: "300px",
    borderRadius: "50%",
    backgroundColor: "rgba(166, 133, 226, 0.15)",
    filter: "blur(100px)",
    pointerEvents: "none",
  },
  container: {
  ...
  button: {
    ...
    border: "none",
    cursor: "pointer",
    boxShadow: "0 10px 20px rgba(97, 85, 166, 0.2)",
  ...
  brandCol: {
    gridColumn: "span min(2, max-of-columns)",
    minWidth: "260px",
  },
  logo: {
    fontSize: "2rem",
