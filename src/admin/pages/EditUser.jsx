...
import ProfileQRCode from "../../components/qr/ProfileQRCode";
...
export default function EditUser() {
    ...
    const fetchUser = async () => {
        ...
        console.log("FETCHED UNIQUE ID:", user?.uniqueId);
        ...
        try {
            ...
            setForm((prev) => ({
                ...
                leadCapture:
                    user.leadCapture || prev.leadCapture,

                theme:
                    user.theme || prev.theme,
    ...
    const handleSave = useCallback(async () => {
        ...
        try {
            ...
            const sanitised = {
                ...
                profileImage:
                    isBlob(form.profileImage)
                        ? ""
                        : form.profileImage,

                coverImage:
                    isBlob(form.coverImage)
                        ? ""
                        : form.coverImage,

                logoImage:
                    isBlob(form.logoImage)
                        ? ""
                        : form.logoImage,
